				...
				<div id="thumbs" class="navigation">
					...
					<ul class="thumbs noscript">
					  <?php
						...
						$imgcoll = array("IMG_0243.jpg","IMG_0251.jpg","IMG_0283.jpg","IMG_0313.jpg","IMG_0414.jpg","IMG_0469.jpg");
						foreach($imgcoll as $img)
						{
							...
							<li>
								...
								<div class="caption">
								  ...
								  <div class="image-desc">Photos of the team at Fall Fest and the Homecoming Carnival.</div>
								</div>
							</li><!--End Photo-->
							<?php
						}

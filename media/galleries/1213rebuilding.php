			...
			<div class="gallery-container">
				...
				<div id="thumbs" class="navigation">
					...
					<?php
						...
						$imgcoll = array("IMG_0491.jpg","IMG_0522.jpg","IMG_0533.jpg","IMG_9861.jpg","IMG_9865.jpg");
						foreach($imgcoll as $img)
						{
							...
							<li>
								...
								<div class="caption">
								  ...
								  <div class="image-desc">Photos of the team participating in Rebuilding Together Clay County.</div>
								</div>
							</li><!--End Photo-->
							<?php
						}

    ...
    <div id="myCarousel" class="carousel slide">
      <div class="carousel-inner">
        ...
        array(Title => "Our Team", IMG => "teamphoto2015.png", Caption => "FIRST<sup>&reg;</sup> Team 1764 in all of its splendor and glory!", URL => "/ourteam/missionandvalues/", btn => "Find out more"),
